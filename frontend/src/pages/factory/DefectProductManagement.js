...
import { getAllErrorProducts } from "apis/produceApi";
...
function DefectProductManagement() {
  ...
  return (
    <div className="DefectProductManagement">
      <h1
        style={{
          marginTop: "10px",
          marginBottom: "10px",
        ...
        >
          ...
          <TableContainer className="table">
            <Table size="lg" variant="striped" colorScheme="blue">
              ...
              <Tbody>
                {(errorProducts === undefined || errorProducts.length === 0) ? <p>There is no defective product.</p> : errorProducts.map((item, index) => (
                  <Tr key={index}>
                    <Td>
                      <input
                        type="checkbox"
...
export default DefectProductManagement;
